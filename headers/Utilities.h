...
/*
 * Test A: performs a test on 2-way cache of size 128 bytes and line size 32 bytes with RLU as replacement policy
 ...
 * 
 * Test D: performs a replacement test on 1-way cache set assiociative cache to see if it has a direct cache behaviour
